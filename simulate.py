import os
import importlib
from sim_helper.simulator_utils_KMWH import *      # Change according to set airport
...
client, network, classifier = get_simulator_and_model(start_params, MODEL_WEIGHTS)
...
if trajectory_plot:
    plot_trajectory(xs_record, ys_record, USE_FALLBACK)