...
def rotateToHome(x, y):
    ...
    rotx = math.cos(89.98418426513672 * math.pi / 180.0) * x + math.sin(89.98418426513672 * math.pi / 180.0) * y
    roty = -math.sin(89.98418426513672 * math.pi / 180.0) * x + math.cos(89.98418426513672 * math.pi / 180.0) * y
...
def setHomeXYhe(client, x, y, he):
    ...
    client.sendDREF("sim/flightmodel/position/local_x", localx)
    client.sendDREF("sim/flightmodel/position/local_z", localz)
    client.sendDREF("sim/flightmodel/position/psi", - he + 89.98418426513672)
