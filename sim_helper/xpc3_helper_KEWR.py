...
def getStartPosition(cte=0.0, he=0.0, dr=0.0):
    ...
    alt=362.14444; heading=-84.986184; pitch=0.31789625; roll=0.10021035;
...
def getStartCoord():
    return 40.70278549194336, -74.1803970336914

def getStartXY():
    return -15224.2548828125, -22589.46484375

def getEndXY():
    return -15224.2548828125 + 1912.2727003063146, -22589.46484375 + 166.61004931824968

def getEndCoord():
    return 40.701286, -74.157695
