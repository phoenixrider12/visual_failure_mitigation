...
def getStartPosition(cte=0.0, he=0.0, dr=0.0):
    ...
    alt=362.14444; heading=-90.015816; pitch=0.31789625; roll=0.10021035;
...
def getStartCoord():
    return 33.649539, -84.438727

def getStartXY():
    return -40659.2109375, -16733.34375

def getEndXY():
    return -40659.2109375 + 2678.2421860329373, -16733.34375 + 1.4444430003005877

def getEndCoord():
    return 33.649552, -84.409771
