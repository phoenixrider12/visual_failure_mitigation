...
def getStartPosition(cte=0.0, he=0.0, dr=0.0):
    ...
    alt=362.14444; heading=-62.09; pitch=0.31789625; roll=0.10021035;
...
def getStartCoord():
    return 37.628678, -122.393253

def getStartXY():
    return -34662.61328125, -14393.1474609375

def getEndXY():
    return -34662.61328125 + 3078.351318, -14393.1474609375 + 1630.5539

def getEndCoord():
    return 37.614003, -122.358271
