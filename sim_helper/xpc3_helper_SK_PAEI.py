...
def rotateToHome(x, y):
    ...
    rotx = math.cos(159.20054626464844 * math.pi / 180.0) * x + math.sin(159.20054626464844 * math.pi / 180.0) * y
    roty = -math.sin(159.20054626464844 * math.pi / 180.0) * x + math.cos(159.20054626464844 * math.pi / 180.0) * y
...
def setHomeXYhe(client, x, y, he):
    ...
    client.sendDREF("sim/flightmodel/position/local_x", localx)
    client.sendDREF("sim/flightmodel/position/local_z", localz)
    client.sendDREF("sim/flightmodel/position/psi", - he + 159.20054626464844)
