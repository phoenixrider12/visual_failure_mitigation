...
def rotateToHome(x, y):
    ...
    rotx = math.cos(117.91 * math.pi / 180.0) * x + math.sin(117.91 * math.pi / 180.0) * y
    roty = -math.sin(117.91 * math.pi / 180.0) * x + math.cos(117.91 * math.pi / 180.0) * y
...
def setHomeXYhe(client, x, y, he):
    ...
    client.sendDREF("sim/flightmodel/position/local_x", localx)
    client.sendDREF("sim/flightmodel/position/local_z", localz)
    client.sendDREF("sim/flightmodel/position/psi", 117.91-he)
